 ...
 * @author farhatdk
 */
public class tampilanpopupanak2 extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;

    public tampilanlayanananak lynn2 = null;
    /**
     * Creates new form tampilanpopupanak
     */
    public tampilanpopupanak2() {
        initComponents();
        datatable();
    }
    ...
    private void tabelpopupanakMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelpopupanakMouseClicked
            ...
            lynn2.Id = tabelpopupanak.getModel().getValueAt(tabelanak, 0).toString();
            lynn2.nama = tabelpopupanak.getValueAt(tabelanak, 1).toString();
            lynn2.jk = tabelpopupanak.getValueAt(tabelanak, 2).toString();
            lynn2.tgl = tabelpopupanak.getValueAt(tabelanak, 3).toString();
            lynn2.usia = tabelpopupanak.getValueAt(tabelanak, 4).toString();
            lynn2.ayah = tabelpopupanak.getValueAt(tabelanak, 5).toString();
            lynn2.ibu = tabelpopupanak.getValueAt(tabelanak, 6).toString();
            lynn2.alamat = tabelpopupanak.getValueAt(tabelanak, 7).toString();
            lynn2.telepon = tabelpopupanak.getValueAt(tabelanak, 8).toString();
            lynn2.IdAnak2();
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tampilanpopupanak2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tampilanpopupanak2().setVisible(true);
            }
        });
    }
